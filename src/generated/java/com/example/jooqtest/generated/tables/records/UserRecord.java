...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record4<Integer, String, String, String> {
    ...
    private static final long serialVersionUID = -770075864;
    ...
    /**
     * Setter for <code>public.user.info</code>.
     */
    public UserRecord setInfo(String value) {
        set(3, value);
        return this;
    }

    /**
     * Getter for <code>public.user.info</code>.
     */
     ...
     */
    public UserRecord(Integer id, String firstName, String lastName, String info) {
        super(User.USER);
